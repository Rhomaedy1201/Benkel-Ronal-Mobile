    ...
    return Padding(
      ...
      child: ListView.builder(
          ...
          itemBuilder: (BuildContext ctx, index) {
            return InkWell(
              onTap: () {
                Get.to(DetailService(uuid: reservasi[index]['id']!));
              },
              child: Column(
                children: [
                  Container(
                      ...
                      children: [
                              ...
                              Container(
                                ...
                                child: GridView(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      reservasi[index]['jam']!.toUpperCase(),
                                      maxLines: 10,
                                      style: const TextStyle(
                                        fontSize: 14,
                                      ),
                              ...
                              Container(
                                ...
                                child: GridView(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      reservasi[index]['status']!.toUpperCase(),
                                      maxLines: 10,
                                      style: TextStyle(
                                        fontSize: 14,
                                        color: reservasi[index]['status'] !=
                                                "cancelled"
                                            ? Colors.black
                                            : Colors.red,
                                      ),
                        ...
                        Padding(
                          ...
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Text(reservasi[index]['kendaraan']['model']!),
                              const SizedBox(height: 2),
                              Text(
                                  reservasi[index]['kendaraan']['tipe_mobil']!),
                              SizedBox(height: 10),
                              Container(
                                width: MediaQuery.of(context).size.width / 1.3,
                                height: MediaQuery.of(context).size.height / 33,
                                child: GridView(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      reservasi[index]['kendaraan']['nopol']!
                                          .toUpperCase(),
                                      maxLines: 10,
                                      style: const TextStyle(
                                        fontSize: 14,
                              ...
                              Container(
                                ...
                                child: GridView(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      reservasi[index]['kendaraan']['warna']!
                                          .toUpperCase(),
                                      maxLines: 10,
                                      style: const TextStyle(
                                        fontSize: 14,
